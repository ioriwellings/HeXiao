...
namespace Langben.DAL
{
    ...
    /// 政策主表
    /// </summary>
    public partial class InsuranceRepository : BaseRepository<Insurance>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<Insurance> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Insurance>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取政策主表---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>政策主表</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>政策主表</returns>
        public Insurance GetById(SysEntities db, string id)
        { 
            return db.Insurance.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条政策主表的主键</param>
        public void Delete(SysEntities db, string id)
        {
            Insurance deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.Insurance.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<Insurance> collection = from f in db.Insurance
