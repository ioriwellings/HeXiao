...
namespace Langben.BLL
{
    ...
    public partial class PoliceInsuranceBLL :  IBLL.IPoliceInsuranceBLL, IDisposable
    {
        ...
        /// <returns>结果集</returns>
        public List<PoliceInsurance> GetByParam(string id, int page, int rows, string order, string sort, string search, ref int total)
        {
            IQueryable<PoliceInsurance> queryData = repository.GetData(db, order, sort, search).Where(w=>w.InsuranceId==id);
            ...
            if (total > 0)
            {
                ...
                else
                {
                    ...
                    {
                        if (item.InsuranceId != null && item.Insurance != null)
                        { 
                                item.InsuranceIdOld = item.Insurance.Name.GetString();//                            
                        }                  
        ...
        /// <param name="total">结果集的总数</param>
        /// <returns>结果集</returns>
        public List<PoliceInsurance> GetByParam(string id, string order, string sort, string search)
        {
        ...
        public PoliceInsurance GetById(string id)
        {           
        ...
        /// <summary>
        /// 根据InsuranceIdId，获取所有社保政策数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public List<PoliceInsurance> GetByRefInsuranceId(string id)
        {
            return repository.GetByRefInsuranceId(db, id).ToList();                      
        }
