...
namespace Langben.BLL
{
    ...
    public partial class PoliceAccountNatureBLL :  IBLL.IPoliceAccountNatureBLL, IDisposable
    {
        ...
        /// <returns>结果集</returns>
        public List<PoliceAccountNature> GetByParam(string id, int page, int rows, string order, string sort, string search, ref int total)
        {
        ...
        /// <param name="total">结果集的总数</param>
        /// <returns>结果集</returns>
        public List<PoliceAccountNature> GetByParam(string id, string order, string sort, string search)
        {
            IQueryable<PoliceAccountNature> queryData = repository.GetData(db, order, sort, search);
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">户口性质的集合</param>
        /// <returns></returns>    
        ...
        public PoliceAccountNature GetById(string id)
        {           
