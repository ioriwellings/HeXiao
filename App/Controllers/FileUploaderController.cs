...
namespace Langben.App.Controllers
{
    ...
    public class FileUploaderController : BaseController
    {
        ...
        public string UpExcle()//头像上传
        {
            ...
            string newFileName = upFiles.fileSaveAs2(pstFile, upfile);
            ...
            entity.Path = upfile;//应该增加一个ResumeName字段，存储简历的名称
            entity.FullPath = newFileName;
