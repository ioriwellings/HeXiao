...
namespace Langben.App.Controllers
{
    ...
    /// 对比结果
    /// </summary>
    public class MYResultApiController : BaseApiController
    {
        ...
        /// <returns></returns>
        public Common.ClientResult.Result Post([FromBody]MYResult entity)
        {           
        ...
        public MYResultApiController()
            : this(new MYResultBLL()) { }

        public MYResultApiController(MYResultBLL bll)
        {
            m_BLL = bll;
        }
    }
